...
__all__ = ['NONLocalBlock1D', 'NONLocalBlock2D', 'NONLocalBlock3D']
class _NonLocalBlockND(nn.Module):
    def __init__(self, in_channels, index=5, inter_channels=None, dimension=3, sub_sample=True, use_bn=True):
...
if __name__ == '__main__':
    ...
    for (sub_sample, use_bn) in [(True, True), (False, False), (True, False), (False, True)]:
